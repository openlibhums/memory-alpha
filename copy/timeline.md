...
### 2015
- Caroline and Martin secure a major grant of $741,000 from the Andrew W. Mellon Foundation in July 2015, leading to the official launch of OLH in September with seven humanities journals, including the OLH “megajournal,” using software provided by Ubiquity Press.
...
### 2017
- Andy Byers joins OLH to build Janeway, an open-source platform released under a copyleft license ([AGPL v3](https://www.gnu.org/licenses/agpl-3.0.html)) to prevent commercial acquisition. Their concerns are validated when Elsevier acquires BePress, an independent academic software provider founded at UC Berkeley.
