export function animateGeorge() {
  ...
  const playPauseButton = document.querySelector(
    ".george-space-splash .play-pause button",
  );
  ...
  const selectSlide1 = document.querySelector(
    ".george-space-splash .select-slide-1 button",
  );
  ...
  const selectSlide2 = document.querySelector(
    ".george-space-splash .select-slide-2 button",
  );
