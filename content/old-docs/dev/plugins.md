...
Other than the unique nature of plugin_settings, hooks and events
...
available at plugins/SHORT_NAME/path/
...
the register_for_events function in plugin_settings.
