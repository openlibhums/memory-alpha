...
- Press  
  - This top level OAI-PMH feed will include records for all journal
    articles in the Janeway installation.

- Journal  
  - The journal OAI-PMH feed contains only records for articles in this
    journal.

- Repository  
  - The repository feed contains only records for objects in this
    repository.
