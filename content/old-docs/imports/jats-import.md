...
If you want to import multiple JATS files or a single JATS file with its
...
Once you have prepared you zip file you can follow the instructions
...
Download the `JATS import sample <nstatic/jats_import_sample.zip>` CSV
