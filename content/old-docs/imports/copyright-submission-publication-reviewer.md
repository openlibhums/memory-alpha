...
1.  Download the `import template <nstatic/cspr_import_template.csv>`.
...
3.  On the Imports Plugin main page select **Copyright, Submission,
    Publication Fees & Reviewer Guidelines Import** and click **Start
    Import**.
...
Download the `import sample <nstatic/cspr_import_sample.csv>` CSV to see
example data.
