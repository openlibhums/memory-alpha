...
<figure>
<img src="/_static/image_guidelines/header_image_olh.png"
class="screenshot"
alt="/_static/image_guidelines/header_image_olh.png" />
<figcaption>Example of header image with OLH theme</figcaption>
</figure>

<figure>
<img src="/_static/image_guidelines/header_image_material.png"
class="screenshot"
alt="/_static/image_guidelines/header_image_material.png" />
...
<figure>
<img src="/_static/image_guidelines/cover_image_olh.png"
class="screenshot"
alt="/_static/image_guidelines/cover_image_olh.png" />
...
<figure>
<img src="/_static/image_guidelines/cover_image_material.png"
class="screenshot"
alt="/_static/image_guidelines/cover_image_material.png" />
...
<figure>
<img src="/_static/image_guidelines/article_large_image.png"
class="screenshot"
alt="/_static/image_guidelines/article_large_image.png" />
...
website or web page. A web designer can create such an icon and upload
it to a website (or web page) by several means, and graphical web
browsers will then make use of it. Browsers that provide favicon support
typically display a page's favicon in the browser's address bar
(sometimes in the history as well) and next to the page's name in a list
of bookmarks. Browsers that support a tabbed document interface
typically show a page's favicon next to the page's title on the tab, and
site-specific browsers use the favicon as a desktop icon.
