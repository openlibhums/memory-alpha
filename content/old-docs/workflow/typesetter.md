...
!["The typesetter Dashboard displaying the number of typesetter tasks assigned."](../images/workflow/typesetting-dashboardblock.png)
...
- Completion date
!["The ‘Typesetting assignments’ page."](../images/workflow/typesetting-assignments.png)
...
!["The ‘Assignment information’ page."](../images/workflow/typesetting-assignments.png)
...
!["The files section of the typesetting page. It shows the ‘Files to typeset’, ‘Upload typeset files’ and ‘Upload source file’ options."](../images/workflow/typesetting-files.png)
...
!["The ‘Upload a typeset file’ upload. It provides the options to add a label for the file, toggle whether the file should be publicly available after the article is published, choose a file to upload, and then confirm the upload."](../images/workflow/typesetting-upload.png)
...
This page can be accessed by clicking on the ‘Edit’ button.
 ...
 !["The ‘Upload typeset files’ section, showing two uploaded files. It also displays the figure files’ status: ‘N/A’ for a file with no figure files and ‘Missing figures’ for a file with missing figures."](../images/workflow/typesetting-edit-button.png)

 !["The ‘Edit typeset file’ page."](../images/workflow/typesetting-filehistory.png)
...
!["The File history and Metadata page."](../images/workflow/typesetting-edit-file.png)

### Managing images and figure files
!["A screenshot displaying the available options for adding image files: uploading a file in a section for a dedicated image (displaying its filename), uploading images as additional files or uploading a zip file."](../images/workflow/typesetting-image-upload.png)
