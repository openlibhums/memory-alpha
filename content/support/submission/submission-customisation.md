...
The option to configure the submission information page for authors can be found under **Content** by clicking **Submission page items**. This is because the submission page is considered to be web content. 
...
The configuration options for the submission form, however, can be found under **Submission** by clicking on **Submission fields configurator**. This is because it directly affects the submission process. 
...
From here you can turn on or off the standard submission fields Janeway comes with.
This affects what fields are and arent displayed. From here you ]
