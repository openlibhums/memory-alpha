...
* Use sentence case for section headings: capitalise the first word, but do not use a period at the end.
* Use serial commas.
...
Note: This can be modified, updated and overwritten as required.
