...
> [!CAUTION]
> Check to ensure no additional files other than publishable galleys are visible here. If they are, they will also be published alongside the galleys. If any other files appear here, return to the typesetting stage to delete files that have accidentally been added as galleys before proceeding.
