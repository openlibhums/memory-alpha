...
To add a homepage element, select **Add** under **Add homepage features** and then select **Configure** to view its options. You can also reorder elements by dragging and dropping them.
