...
![copyeditor dashboard block](../support/images/workflow/copyeditor-dashboard.png)

This will take you to the following page:
![Copyeditor requests page. The three columns on the ‘Copyedit Requests’ page (‘Awaiting initial decision’, ‘In progress’ and ‘Completed’. There is a task in the middle column that has been accepted.](../support/images/workflow/copyeditor-requests.png)
...
- In Progress
  - Taks you have accepted but not completed.
...
![The ‘Article Copyediting’ page. It displays information about the manuscript, the article files, completed files and a ‘comments to the editor’ textbox. The ‘Download’, ‘Upload File’ and ‘Complete copyedit task’ buttons are highlighted.](../support/images/workflow/copyedit-page.png)

### Article files & copyedited files

![The ‘Article files’ and ‘Copyedited files’ section. It shows the files, their filenames, labels and download buttons. There is also an upload file button for copyedited files.](../support/images/workflow/copyedit-files.png)
...
![The ‘Complete task’ section with a textbox for the notes to the editor. There is a ‘Complete copyedit task’ button at the bottom.](../support/images/workflow/copyedit-complete-task.png)
...
![The three columns on the ‘Copyedit Requests’ page, ‘Awaiting initial decision’, ‘In progress’ and ‘Completed’. There is a task in the right column that has been completed.](../support//images/workflow/copyedit-complete-kanban.png)
...
![The three columns on the ‘Copyedit Requests’ page (‘Awaiting initial decision’, ‘In progress’ and ‘Completed’. There is a task that has been reopened in the middle and the original completed task on the right.](../support/images/workflow/copyedit-reopened-kanban.png)
