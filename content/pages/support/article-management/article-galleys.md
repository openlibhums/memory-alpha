...
Whichever way you make changes to a JATS-XML file, it is recommended to check it using the [preview function in Janeway](../guides/workflow-editor-typesetting.md#upload-galleys-yourself-workflow) to proof the galley to ensure it displays correctly.
