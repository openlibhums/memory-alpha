...
- **Article files**  
   A list of the files supplied by the editor for copyediting. From here, you can download the necessary files to work on and any supplemental files (e.g., additional figures) by clicking the <img alt="" src="../../support/images/download-icon.png" width="12" height="12"/> **Download** icon.

- **Copyedited files**  
   A list of files you have uploaded. Use the <img alt="" src="../../support/images/upload-icon.png" width="12" height="12"/> **Upload file** button to add a new file when you have completed copyediting it.
...
This is where you can find the necessary files to complete the copyediting task. This will include the manuscript and other files, such as figures. You can upload the copyedited manuscript using the <img alt="" src="../../support/images/upload-icon.png" width="12" height="12"/> **Upload file** button.
...
![The three columns on the Copyedit Requests page, Awaiting initial decision, In progress and Completed. There is a task in the right column that has been completed.](../images/workflow/copyedit-complete-kanban.png)
