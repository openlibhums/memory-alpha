...
The contact import tool allows you to create contacts by uploading a CSV file.

> [!WARNING]
> As of the latest version of the imports plugin (v1.12), this importer does not work on Janeway 1.9.0 due to changes in data model for contacts.
