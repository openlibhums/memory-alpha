...
# Sitemap (Pelican plugin)
# See also themes/alpha/static/robots.txt
SITEMAP = {
    "exclude": [
        # Pages auto-generated by Pelican in its blog framework capacity
        "^archives.html$",
        "^author/",
        "^authors.html$",
        "^category/",
